...
public class EditOutTransmittalPane extends ZbyteEditDbRowPane implements PageFinishedListener 
{
	
	public EditOutTransmittalPane() {
		super(ZbyteDatabase.OutTransmittal, null);
	...
	public void init() {
		...
		try {		
			...
			dbParms.dbTable = ZbyteDatabase.OutTransmittal;
			dbParms.query = "select * from " + ZbyteDatabase.OutTransmittal;
			...
			w = new Wizard("Outbound Transmittal");
...
//		
		EditOutTransmittalPane gj = new EditOutTransmittalPane();
...
//			}
			...
			TransmittalHtmlFormatter thf = new TransmittalHtmlFormatter(ot_start.getEditDbRowPane());
