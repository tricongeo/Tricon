...
public class ZbyteZscanProgress extends JApplet implements PageFinishedListener 
{
	...
	public void init() {
		...
		try {
			...
			deliverable_select.setVisibleColumns(new String[] {"Select", "Barcode", "Image File", "Line #", "Operator:","Support Type:", "Media:", "Copy Date", "Job:", "State", "County", "id", "Control Num:", "Comment"});
...
//		
		ZbyteZscanProgress gj = new ZbyteZscanProgress();
...
//		frame.setVisible(true);
	...
	public void pageFinished(WizardPage currentPage) {
		ModelTransferItemFactory stif = new ZscanTransferItemFactory();
