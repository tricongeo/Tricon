...
public class ZbyteTransmittal extends JApplet 
{
	@Override
	public void init() {
		Container c = this.getContentPane();
		try {
			ZbyteDbSpreadsheetPanel out_transmittalPanel = (ZbyteDbSpreadsheetPanel) ZbyteDbSpreadsheetPanel.makePanel("ZbyteDatabase", ZbyteDatabase.ZbyteTransmittal);
			out_transmittalPanel.setEditableColumns(new String[]{""});
			...
			transPane.setName("Inter-Office Transmittal");
			transPane.add(out_transmittalPanel);
	...
	protected static void createAndShowGUI() {
		JFrame frame = new JFrame("Inter-Office Transmittals");
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		ZbyteTransmittal gj = new ZbyteTransmittal();
