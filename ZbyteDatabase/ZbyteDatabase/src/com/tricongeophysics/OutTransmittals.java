...
public class OutTransmittals extends JApplet 
{
	@Override
	public void init() {
		Container c = this.getContentPane();
		try {
			ZbyteDbSpreadsheetPanel out_transmittalPanel = (ZbyteDbSpreadsheetPanel) ZbyteDbSpreadsheetPanel.makePanel("ZbyteDatabase", ZbyteDatabase.OutTransmittal);
			...
			transPane.setName("Out Transmittal");
	...
	protected static void createAndShowGUI() {
		JFrame frame = new JFrame("Outbound Transmittals");
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		
		OutTransmittals gj = new OutTransmittals();
