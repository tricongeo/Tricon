...
public class InterOfficeTransmittalHtmlFormatter {

	private InterOfficeTransmittalEditDbRowPane editDbRowPane;
	private Object date;
	...
	public InterOfficeTransmittalHtmlFormatter(EditDbRowPane editDbRowPane) {
		this.editDbRowPane = new InterOfficeTransmittalEditDbRowPane(editDbRowPane);
	}
	...
	public String getHtml() {
		...
		getTotals();
		 String zbytePath = "";
	        try {
	        	zbytePath  = InterOfficeTransmittalHtmlFormatter.class.getResource("images/zbyte_logo.png").toExternalForm();
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
		...
		html += "</td><td>" + "\n";
		html += "<FONT SIZE=5>"+ "\n";
		html += "Inter-Office Transmittal ID: " + transmittalID + "\n";
		html += "</td></tr><tr><td>" + "\n";
		html += "<FONT SIZE=5>"+ "\n";
		...
		html += "<P></P>"+ "\n";
		html += "<FONT SIZE=5>" + "\n";
		html += "<B>INTER-OFFICE TRANSMITTAL</B><br>"+ "\n";
		html += "<P></P>"+ "\n";
		html += "<B>Job: </B>"+jobNum+ "<br>\n";
		html += "<B>From: </B>"+fromOffice+ "<br>\n";
	...
	private void getFields() {
		officeName = editDbRowPane.getOfficeName();
		...
		fromOffice = editDbRowPane.getFromOffice();
		jobNum = editDbRowPane.getJob();
	}
