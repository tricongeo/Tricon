...
//			}
//		}
        double x = traces.get(0).getHeaderValue(ParadigmDataSetIO.CDPX_HEADER);
        double y = traces.get(0).getHeaderValue(ParadigmDataSetIO.CDPY_HEADER);
        if (x == 0.0 && y == 0.0)
        {
    ...
    public int getCDP()
    {
        return (int) traces.get(0).getHeaderValue(ParadigmDataSetIO.CDP_HEADER);
    }
